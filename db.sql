...
--
-- Host: localhost    Database: AnonymGreetings
-- ------------------------------------------------------
...
--
-- Table structure for table `accepted_quests`
--

DROP TABLE IF EXISTS `accepted_quests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `accepted_quests` (
...
--
-- Dumping data for table `accepted_quests`
--

LOCK TABLES `accepted_quests` WRITE;
/*!40000 ALTER TABLE `accepted_quests` DISABLE KEYS */;
/*!40000 ALTER TABLE `accepted_quests` ENABLE KEYS */;
UNLOCK TABLES;
